  ...
  source_configuration {
    image_repository {
      image_configuration {
        ...
        BUILDKITE_AGENT_TOKEN = "1161a15b6857639d71a8591ea1cc770167801d0d93cdc7dc81",
        STFP_HOST = "sftp.cloudfoxlabs.com",
        SFTP_USER = "musah",
        SFTP_PASSWORD = "ACMILAN2023",
        SLACK_API_TOKEN = "xoxb-20231234-k3s232ds34d63453fs4532",
        SLACK_CHANNEL = "cloudfox",
    }
      }
